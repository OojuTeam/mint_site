class ProjectsController < ApplicationController
  ...
  def project_params
    params.require(:project).permit(:name, :description, :launch_epoch, :mint_qty_default, :mint_qty_max, :purchase_price, :purchase_price_friendly, :network, :contract_address)
  end
